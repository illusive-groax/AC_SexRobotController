...
> [!Warning]
> The reading from file has not yet been thoroughly tested and may therefore not work as intended (even if a valid name was added to the file, the SR6 may not move).
> Furthermore, not all possible animation combinations has been added, which also results in the potential of movement not working, since the functionality isn't there.
...
- 3P
- 5P
- Button shortcuts to Settings menu(if applicable)
- Reading animations from file
- Writing unknown animations to file
- Ability to override existing animations (e.g. if an animation is added, but the tracked part is wrong, this would then use the file content instead of library value)
...
![plugin](screenshots/ac_ClothingMenu_limitButton.png)
